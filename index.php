...
<p class="page-header"> <label style="text-decoration: underline">Name: </label> <?php echo $userName ?></p>
<p><label style="text-decoration: underline" >Department: </label> <?php echo $userDepartment ?></p>
<p><label style="text-decoration: underline" >Clock Number: </label> <?php echo $userClock ?></p>
<p><label style="text-decoration: underline" >Issues: </label> <?php echo $userIssue ?></p>
<p><label style="text-decoration: underline" >Changes: </label> <?php echo $userProfession ?></p>
